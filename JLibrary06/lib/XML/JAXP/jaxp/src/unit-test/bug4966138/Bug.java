/*
 * @(#)$Id: Bug.java,v 1.1 2005/06/10 04:24:09 jeffsuttor Exp $
 *
...
public class Bug extends TestCase {
    ...
    public void test1() throws Exception {
        ...
        assertTrue("returned typeName shouldn't be empty",typeName.length()!=0);

        String typeNs = type.getTypeNamespace();
        System.out.println(typeNs);
        assertNotNull(typeNs);
        assertTrue("returned typeNamespace shouldn't be empty",typeNs.length()!=0);
       }
}
