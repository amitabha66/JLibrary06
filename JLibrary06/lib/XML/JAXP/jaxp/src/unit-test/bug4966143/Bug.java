/*
 * @(#)$Id: Bug.java,v 1.1 2005/06/10 04:23:13 jeffsuttor Exp $
 *
...
public class Bug extends TestCase {
    ...
    public void test1() throws Exception {
        ...
        assertFalse(type.isDerivedFrom("testNS", "Test", TypeInfo.DERIVATION_LIST));
        assertFalse(type.isDerivedFrom("testNS", "Test", TypeInfo.DERIVATION_RESTRICTION));
        assertTrue (type.isDerivedFrom("testNS", "Test", TypeInfo.DERIVATION_EXTENSION));
        assertTrue (type.isDerivedFrom("testNS", "Test", 0));
    }
}