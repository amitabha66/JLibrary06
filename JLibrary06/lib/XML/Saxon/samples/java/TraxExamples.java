...
public class TraxExamples {
    ...
    public static void main(String argv[]) {
        ...
        if (test.equals("all") || test.equals("exampleDOMImport")) {
            System.out.println("\n\n==== exampleDOMImport ====");
    ...
    public static NodeInfo exampleSaxonToSaxon(String sourceID, String xslID)
        ...
        NodeInfo doc = new XPathEvaluator(config).setSource(new StreamSource(new File(xslID).toURL().toString()));
        Templates templates = tfactory.newTemplates(doc);
        System.err.println("Stylesheet built OK");

        Transformer transformer = templates.newTransformer();
        doc = new XPathEvaluator(config).setSource(new StreamSource(new File(sourceID).toURL().toString()));
