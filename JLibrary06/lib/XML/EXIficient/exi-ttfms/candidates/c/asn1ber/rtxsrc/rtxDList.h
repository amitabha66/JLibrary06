 ...
 */ 
EXTERNRTX OSRTDListNode* rtxDListAppend 
(struct OSCTXT* pctxt, OSRTDList* pList, void* pData);

EXTERNRTX OSRTDListNode* rtxDListAppendNode 
 ...
 */
EXTERNRTX OSRTDListNode* rtxDListInsert 
(struct OSCTXT* pctxt, OSRTDList* pList, OSUINT32 index, void* pData);

EXTERNRTX OSRTDListNode* rtxDListInsertNode 
 ...
 *                        link the given data value into the list.
 */
EXTERNRTX OSRTDListNode* rtxDListInsertBefore 
 ...
 *                        link the given data value into the list.
 */
EXTERNRTX OSRTDListNode* rtxDListInsertAfter 
(struct OSCTXT* pctxt, OSRTDList* pList, OSRTDListNode* node, void* pData);
 ...
 */
EXTERNRTX void rtxDListFreeNode
 ...
 */
EXTERNRTX int rtxDListAppendArray 
 ...
 *                        negative return value is error.
 */
EXTERNRTX int rtxDListAppendArrayCopy 
 ...
 *                        negative return value is error.
 */
EXTERNRTX int rtxDListToUTF8Str 
...
rtxMemAlloc (pctxt, sizeof(type)+sizeof(OSRTDListNode)); \
if (0 != *ppnode) { \
(*ppnode)->data = (void*)((char*)(*ppnode)+sizeof(OSRTDListNode)); \
...
EXTERNRTX void rtxDListBufInit (OSRTDListBuf* pBuf,
