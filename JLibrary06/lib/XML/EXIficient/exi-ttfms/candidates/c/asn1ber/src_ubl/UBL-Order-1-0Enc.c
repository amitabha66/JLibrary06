   ...
   EarliestDate *pvalue, ASN1TagType tagging)
{
   ...
   ll = asn1E_EarliestDateType (pctxt, pvalue, tagging);
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll0 += ll;
   ...
   ValidityDurationMeasure *pvalue, ASN1TagType tagging)
{
   ...
   ll = asn1E_ValidityDurationMeasureType (pctxt, pvalue, tagging);
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll0 += ll;
   ...
   TotalPackagesQuantity *pvalue, ASN1TagType tagging)
{
   ...
   ll = asn1E_PackagesQuantityType (pctxt, pvalue, tagging);
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll0 += ll;
   ...
   UBL_Order_1_0_LineItemCountNumeric *pvalue, ASN1TagType tagging)
{
   ...
   ll = asn1E_UBL_Order_1_0_LineItemCountNumericType (pctxt, pvalue, tagging);
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll0 += ll;
   ...
   OrderType *pvalue, ASN1TagType tagging)
{
   ...
   ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|33,
      asn1E_OrderType_orderLine_list (pctxt, &pvalue->orderLine_list, ASN1IMPL));
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll1 += ll;
   ...
   if (pvalue->m.destinationCountryPresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|32,
         asn1E_DestinationCountry (pctxt, &pvalue->destinationCountry, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   if (pvalue->m.freightForwarderPartyPresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|27,
         asn1E_UBL_Order_1_0_FreightForwarderParty (pctxt, &pvalue->freightForwarderParty, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   if (pvalue->m.originatorPartyPresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|26,
         asn1E_OriginatorParty (pctxt, &pvalue->originatorParty, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   /* encode sellerParty */
   ...
   ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|23,
      asn1E__SeqOfUBL_Order_1_0_AdditionalDocumentReference (pctxt, &pvalue->additionalDocumentReference_list, ASN1IMPL));
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll1 += ll;
   ...
   if (pvalue->m.quoteDocumentReferencePresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|22,
         asn1E_QuoteDocumentReference (pctxt, &pvalue->quoteDocumentReference, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   if (pvalue->m.contractDocumentReferencePresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|21,
         asn1E_ContractDocumentReference (pctxt, &pvalue->contractDocumentReference, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   if (pvalue->m.lineItemCountNumericPresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|20,
         asn1E_UBL_Order_1_0_LineItemCountNumeric (pctxt, &pvalue->lineItemCountNumeric, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   /* encode totalPackagesQuantity */

   if (pvalue->m.totalPackagesQuantityPresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|14,
         asn1E_TotalPackagesQuantity (pctxt, &pvalue->totalPackagesQuantity, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   if (pvalue->m.validityDurationMeasurePresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|11,
         asn1E_ValidityDurationMeasure (pctxt, &pvalue->validityDurationMeasure, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   /* encode expiryDate */
   ...
   if (pvalue->m.earliestDatePresent) {
      ll = xe_tag_len (pctxt, TM_CTXT|TM_CONS|9,
         asn1E_EarliestDate (pctxt, &pvalue->earliestDate, ASN1IMPL));
      if (ll < 0) return LOG_RTERR (pctxt, ll);
      ll1 += ll;
   }
   ...
   Order *pvalue, ASN1TagType tagging)
{
   ...
   ll = asn1E_OrderType (pctxt, pvalue, tagging);
   if (ll < 0) return LOG_RTERR (pctxt, ll);
   ll0 += ll;
