 ...
 *                       - negative return value is error
 */
EXTERNRTX int rtxDateTimeToString 
   (const OSNumDateTime* pvalue, OSUTF8CHAR* buffer, size_t bufsize);
 ...
 *                       - negative return value is error
 */
EXTERNRTX int rtxGYearToString 
   (const OSNumDateTime* pvalue, OSUTF8CHAR* buffer, size_t bufsize);
 ...
 *                       - negative return value is error
 */
EXTERNRTX int rtxGYearMonthToString 
   (const OSNumDateTime* pvalue, OSUTF8CHAR* buffer, size_t bufsize);
 ...
 *                       - negative return value is error
 */
EXTERNRTX int rtxGMonthToString 
   (const OSNumDateTime* pvalue, OSUTF8CHAR* buffer, size_t bufsize);
 ...
 *                       - negative return value is error
 */
EXTERNRTX int rtxGMonthDayToString 
   (const OSNumDateTime* pvalue, OSUTF8CHAR* buffer, size_t bufsize);
 ...
 */
EXTERNRTX int rtxGetCurrDateTime (OSNumDateTime* pvalue);
 ...
 */
EXTERNRTX int rtxParseDateString
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseTimeString
(const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseDateTimeString
   (const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseGYearString
   (const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseGYearMonthString
   (const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseGMonthString
   (const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseGMonthDayString
   (const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxParseGDayString
   (const OSUTF8CHAR* inpdata, size_t inpdatalen, OSNumDateTime* pvalue);
 ...
 *                     -1 unsuccessul
 */
EXTERNRTX int rtxMSecsToDuration
 ...
 *                       Return value is taken from rtxErrCodes.h header file
 */
EXTERNRTX int rtxDurationToMSecs 
 ...
 *                  - negative return value is error.
 */
EXTERNRTX int rtxSetDateTime (OSNumDateTime* pvalue, struct tm* timeStruct);
 ...
 *                  - negative return value is error.
 */
EXTERNRTX int rtxSetLocalDateTime (OSNumDateTime* pvalue, time_t timeMs);
 ...
 *                  - negative return value is error.
 */
EXTERNRTX int rtxSetUtcDateTime (OSNumDateTime* pvalue, time_t timeMs);
 ...
 *                  - negative return value is error.
 */
EXTERNRTX int rtxGetDateTime (const OSNumDateTime* pvalue, time_t* timeMs);
 ...
 */
EXTERNRTX OSBOOL rtxDateTimeIsValid (const OSNumDateTime* pvalue);
