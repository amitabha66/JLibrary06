...
rtxMemBufAppend(pmb,(OSOCTET*)str,strlen(str))
 ...
 *                       - negative return value is error.
 */
EXTERNRTX int rtxMemBufCut (OSRTMEMBUF* pMemBuf, size_t fromOffset, size_t nbytes);
 ...
 * @param pMemBuf      A pointer to a memory buffer structure.
 */
EXTERNRTX void rtxMemBufFree (OSRTMEMBUF* pMemBuf);
 ...
 */
EXTERNRTX OSOCTET* rtxMemBufGetData (OSRTMEMBUF* pMemBuf, int* length);
 ...
 */
EXTERNRTX int rtxMemBufGetDataLen (OSRTMEMBUF* pMemBuf); 
 ...
 */
EXTERNRTX void rtxMemBufInit (OSCTXT* pCtxt, OSRTMEMBUF* pMemBuf, 
                              size_t segsize);
 ...
 */
EXTERNRTX void rtxMemBufInitBuffer (OSCTXT* pCtxt, OSRTMEMBUF* pMemBuf, 
 ...
 *                       - negative return value is error.
 */
EXTERNRTX int rtxMemBufPreAllocate (OSRTMEMBUF* pMemBuf, size_t nbytes);
 ...
 * @param pMemBuf      A pointer to a memory buffer structure.
 */
EXTERNRTX void rtxMemBufReset (OSRTMEMBUF* pMemBuf);
 ...
 *                       - negative return value is error.
 */
EXTERNRTX int rtxMemBufSet (OSRTMEMBUF* pMemBuf, OSOCTET value, size_t nbytes);
 ...
 */
EXTERNRTX OSBOOL rtxMemBufSetExpandable 
 ...
 *                       - negative return value is error.
 */
EXTERNRTX int rtxMemBufTrimW (OSRTMEMBUF* pMemBuf); 
