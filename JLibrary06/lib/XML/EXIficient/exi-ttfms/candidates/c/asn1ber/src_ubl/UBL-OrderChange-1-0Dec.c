   ...
   UBL_OrderChange_1_0_EarliestDate *pvalue, ASN1TagType tagging, int length)
{
   ...
   stat = asn1D_UBL_OrderChange_1_0_EarliestDateType (pctxt, 
   ...
   UBL_OrderChange_1_0_ValidityDurationMeasure *pvalue, ASN1TagType tagging, int length)
{
   ...
   stat = asn1D_UBL_OrderChange_1_0_ValidityDurationMeasureType (pctxt, 
      pvalue, tagging, length);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   ...
   TotalPackagesCountQuantity *pvalue, ASN1TagType tagging, int length)
{
   ...
   stat = asn1D_PackagesCountQuantityType (pctxt, 
      pvalue, tagging, length);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   ...
   UBL_OrderChange_1_0_LineItemCountNumeric *pvalue, ASN1TagType tagging, int length)
{
   ...
   stat = asn1D_UBL_OrderChange_1_0_LineItemCountNumericType (pctxt, 
      pvalue, tagging, length);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   ...
   OrderChangeType *pvalue, ASN1TagType tagging, int length)
{
   ...
   while (!XD_CHKEND (pctxt, &ccb)) {
      ...
      case 6:
         /* decode sequenceNumberID */
         if (XD_PEEKTAG (pctxt, 0x86)) {
            stat = xd_Tag1AndLen (pctxt, &length);
            if (stat != 0) return LOG_RTERR (pctxt, stat);

            stat = asn1D_UBL_UnspecializedDatatypes_1_0_IdentifierType (pctxt, 
               &pvalue->sequenceNumberID, ASN1IMPL, length);
            if (stat == 0) {
               if (length == ASN_K_INDEFLEN) {
                  if (XD_MATCHEOC (pctxt)) XD_BUMPIDX (pctxt, 2);
                  else return LOG_RTERR (pctxt, ASN_E_INVLEN);
      ...
      case 11:
         ...
         if (XD_PEEKTAG (pctxt, 0x8b)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_EarliestDate (pctxt, 
      ...
      case 13:
         ...
         if (XD_PEEKTAG (pctxt, 0x8d)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_ValidityDurationMeasure (pctxt, 
      ...
      case 16:
         ...
         if (XD_PEEKTAG (pctxt, 0x90)) {
            ...
            stat = asn1D_TotalPackagesCountQuantity (pctxt, 
      ...
      case 22:
         ...
         if (XD_PEEKTAG (pctxt, 0x96)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_LineItemCountNumeric (pctxt, 
      ...
      case 24:
         ...
         if (XD_PEEKTAG (pctxt, 0x98)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_ContractDocumentReference (pctxt, 
      ...
      case 25:
         ...
         if (XD_PEEKTAG (pctxt, 0x99)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_QuoteDocumentReference (pctxt, 
      ...
      case 28:
         ...
         if (XD_PEEKTAG (pctxt, 0x9c)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_OriginatorParty (pctxt, 
      ...
      case 29:
         ...
         if (XD_PEEKTAG (pctxt, 0x9d)) {
            ...
            stat = asn1D_UBL_OrderChange_1_0_FreightForwarderParty (pctxt, 
      ...
      case 34:
         ...
         if ((stat = xd_match (pctxt, TM_CTXT|TM_CONS|34, &length, XM_ADVANCE)) == 0) {
            stat = asn1D_UBL_OrderChange_1_0_DestinationCountry (pctxt, 
      ...
      case 35:
         ...
         if ((stat = xd_match (pctxt, TM_CTXT|TM_CONS|35, &length, XM_ADVANCE)) == 0) {
            stat = asn1D_OrderChangeType_orderLine_list (pctxt, 
      ...
      case 36:
         /* decode paymentMeans */
         if ((stat = xd_match (pctxt, TM_CTXT|TM_CONS|36, &length, XM_ADVANCE)) == 0) {
   ...
   OrderChange *pvalue, ASN1TagType tagging, int length)
{
   ...
   stat = asn1D_OrderChangeType (pctxt, 
      pvalue, tagging, length);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
