...
typedef struct OSRTSTREAM {
   ...
   /* this should be included in extra..
   OSRTSOCKET socket;         *< socket handle for socket streams     */
 ...
 *                       rtxStreamInit.
 */
EXTERNRTX int rtxStreamClose (OSCTXT* pctxt);
 ...
 */
EXTERNRTX int rtxStreamFlush (OSCTXT* pctxt);
 ...
 *                       return value is error.
 */
EXTERNRTX int rtxStreamInit (OSCTXT* pctxt);
 ...
 *                       occurred.
 */
EXTERNRTX long rtxStreamBlockingRead 
 ...
 *                       return value is error.
 */
EXTERNRTX int rtxStreamSkip  (OSCTXT* pctxt, size_t skipBytes);
 ...
 *                       (negative value).
 */
EXTERNRTX int rtxStreamGetIOBytes (OSCTXT* pctxt, size_t* pPos);

/**
 * Marks the current position in this input stream. A subsequent call to the
 * ::rtxStreamReset function repositions this stream at the last marked
 * position so that subsequent reads re-read the same bytes. The \c readAheadLimit
 * argument tells this input stream to allow many bytes to be read before the
 ...
 */
EXTERNRTX int rtxStreamMark (OSCTXT* pctxt, size_t readAheadLimit);
 ...
 *                       return value is error.
 */
EXTERNRTX int rtxStreamReset (OSCTXT* pctxt);
 ...
 */
EXTERNRTX OSBOOL rtxStreamMarkSupported (OSCTXT* pctxt);
 ...
 *                       FALSE otherwise.
 */
EXTERNRTX OSBOOL rtxStreamIsOpened (OSCTXT* pctxt);
 ...
 *                       otherwise.
 */
EXTERNRTX OSBOOL rtxStreamIsReadable (OSCTXT* pctxt);
 ...
 *                       otherwise.
 */
EXTERNRTX OSBOOL rtxStreamIsWritable (OSCTXT* pctxt);
 ...
 *                       return value is error.
 */
EXTERNRTX int rtxStreamRelease (OSCTXT* pctxt);
