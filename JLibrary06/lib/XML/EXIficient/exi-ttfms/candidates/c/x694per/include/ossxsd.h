...
/*****************************************************************************/
/* FILE: @(#)ossxsd.hh	15.4.1.4  06/03/16                                         */
/*****************************************************************************/
...
#define OSSX_NAN_DOUBLE "\x00\x00\x00\x00\x00\x00\xf8\x7f"
#define OSSX_NAN_FLOAT "\x00\x00\xc0\x7f"
#endif
...
#ifndef OSSX_PTR_MAX
#define OSSX_PTR_MAX ((char*)ULONG_MAX)
#endif
...
#ifdef OSSX_64BIT_PLATFORM
#define OSSX_INT32_MAX   INT_MAX
#define OSSX_INT32_MIN   INT_MIN
#else
#define OSSX_INT32_MAX   LONG_MAX
#define OSSX_INT32_MIN   LONG_MIN
#endif
...
typedef struct ossxFunctionTables {
    ...
    void       *reserved[6];    /* Reserved for possible future use */
} OssxFunctionTables;
...
typedef struct ossxMemManagerTbl {
    ...
    unsigned char	*(DLL_ENTRY_FPTR *_System setDumpp)(void *, void **,
							void *, size_t *);
    void		 (DLL_ENTRY_FPTR *_System ossxSetSortp)(void *, void *,
							unsigned char);
    void		 (DLL_ENTRY_FPTR *_System _ossxFreeBUFp)(void *, void *);
    unsigned char	 (DLL_ENTRY_FPTR *_System ossxEgetBytep)(void *, void *,
							unsigned long);
...
#if defined(_WINDOWS) || defined(_WIN32) || defined(WIN32) || \
	defined(__WIN32__) || defined(__OS2__) || defined(NETWARE_DLL)
extern int DLL_ENTRY ossx_test(struct ossxEnv *);
#endif /* _WINDOWS ||_WIN32 || WIN32 || __WIN32__ || __OS2__ || NETWARE_DLL */
...
typedef struct apiTbl {
    ...
    void (DLL_ENTRY_FPTR *_System _ossx_freeMemp)(void *, void *);
    void (DLL_ENTRY_FPTR *_System _ossx_freeGlobalsp)(void *, ossxBoolean);
    void (DLL_ENTRY_FPTR *_System _ossx_freeDerBlocksp_obsolete)(void *);
    void (DLL_ENTRY_FPTR *_System _ossx_enc_freeMemp)(void *, void *);
...
/* XML declaration */
    int (*xmlDecl)(void *data, const char *version, const char *encoding,
 						    const int standalone);
/* DTD */
    int (*startDoctypeDecl)(void *data, const char *name, const char *sysid,
	    const char *pubid, const int has_internal_subset);
    int (*endDoctypeDecl)(void *data, const char *name);
    int (*unparsedEntityDecl)(void *data, const char *entityName, 
		const char *sysid, const char *pubid, const char *notationName);
    int (*notationDecl)(void *data, const char *notationName, 
...
/* Content */
    ...
    int (*characters)(void *user_data, const unsigned char *chars, unsigned int length);
    ...
    int (*comment)(void *user_data, const unsigned char *chars, unsigned int length);
    ...
    int (*unexpEntityRef)(void *data, const char *entityName, 
		const char *sysid, const char *pubid);
} OssxSAXEventTable;
#endif /* OSSXSD_H */
