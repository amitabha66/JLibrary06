...
/*****************************************************************************/
/*****************************************************************************
 * $Id: X694PERFINativeDriver.java,v 1.3 2007/02/19 22:28:08 pthorpe Exp $
 *****************************************************************************/
 ...
 * @since   NEW
 */
public class X694PERFINativeDriver extends BaseNativeDriver
{
    ...
    /**
     * Creates a new instance of X694PERFINativeDriver
     */
    public X694PERFINativeDriver()
    {
    }
    ...
    public String getPrecompiledXMLSchema(TestCase testCase)
    {
	    ...
	    // Stub for FI engine
	    File schemaLib = new File(path, "NONE");
	...
	if (getPrecompiledXMLSchema(testCase) == null)
